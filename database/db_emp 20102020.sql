...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2020 at 01:28 AM
...
--
-- Table structure for table `tb_ceklist`
--

CREATE TABLE `tb_ceklist` (
  `id_ceklist` int(11) NOT NULL,
  `no_wo` varchar(50) NOT NULL,
  `id_customer` int(11) NOT NULL,
  `tgl` date NOT NULL,
  `qcdep` int(11) NOT NULL,
...
INSERT INTO `tb_customer` (`id_customer`, `namacustomer`, `alamat`, `id_kota`, `id_provinsi`, `id_kecamatan`, `id_user`, `tglupdate`) VALUES
(1, 'asdm', 'sfsd', '1505', '15', '1505020', 1, '2020-10-19 06:58:07'),
(2, 'alief', 'sa', '1606', '16', '1606100', 1, '2020-10-19 06:58:17');
...
INSERT INTO `tb_dept` (`id_dept`, `dept`, `id_user`, `tglupdate`) VALUES
(1, 'manager', 1, '2020-10-19 06:18:15');

-- --------------------------------------------------------

--
-- Table structure for table `tb_detailceklist`
--

CREATE TABLE `tb_detailceklist` (
  `id_ceklist` int(11) NOT NULL,
  `id_masterceklist` int(11) NOT NULL,
  `dilakukan` enum('sudah','proses') NOT NULL,
  `dokumentasi` enum('ada','tidak') NOT NULL,
  `tglawal` date NOT NULL,
  `tglakhir` date NOT NULL,
  `suhu` int(11) DEFAULT NULL,
  `id_detailceklist` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `tb_mechanictype`
--

CREATE TABLE `tb_mechanictype` (
  `id_ceklist` int(11) NOT NULL,
  `id_mechanictype` int(11) NOT NULL,
  `acmotor` enum('1','0') NOT NULL DEFAULT '0',
  `dcmotor` enum('1','0') NOT NULL DEFAULT '0',
  `dcgenerator` enum('1','0') NOT NULL DEFAULT '0',
  `variablespeed` enum('1','0') NOT NULL DEFAULT '0',
...
(2, 'SPK', 'fa fa-files-o', 2),
(3, 'Laporan', 'fa fa-pie-chart', 3),
(4, 'Setting', 'fa fa-edit', 4);
...
CREATE TABLE `tb_spk` (
  `no_wo` varchar(50) NOT NULL,
  `id_customer` int(11) NOT NULL,
  `spekmotor` varchar(200) NOT NULL,
  `note` varchar(200) NOT NULL,
  `tglpo` date NOT NULL,
...
INSERT INTO `tb_staf` (`id_user`, `id_tipeuser`, `nama`, `alamat`, `id_kecamatan`, `id_kota`, `id_provinsi`, `tlp`, `jabatan`, `username`, `password`, `id_dept`, `id_userupdate`, `tglupdate`) VALUES
(1, 1, 'administrator', 'sadasd', '3402110', '3402', '34', '083849390', 'asdasd', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, 1, '2020-10-19'),
(3, 1, 'alief tes', 'sadasd', '3402110', '3402', '34', '083849390', 'asdasd', 'arif', 'e10adc3949ba59abbe56e057f20f883e', 1, 1, '2020-10-19');
...
(1, 1, 'Master Customer', 'Customer', 'aktif'),
(2, 1, 'Tipe User', 'Tipeuser', 'aktif'),
(3, 1, 'Master Departement', 'Dept', 'aktif'),
(4, 1, 'Master Staf', 'User', 'aktif'),
(5, 1, 'Master Jenis Pekerjaan', 'Jenispekerjaan', 'aktif'),
(6, 4, 'Setting Kode', '', 'aktif'),
(7, 2, 'Pendataan', '', 'aktif'),
(8, 2, 'Checklist Pekerjaan', '', 'aktif'),
(9, 3, 'Laporan Staf', '', 'aktif'),
(10, 3, 'Laporan Customer', '', 'aktif'),
(11, 3, 'Laporan Departement', '', 'aktif'),
(12, 3, 'List Pekerjaan', '', 'aktif');
...
INSERT INTO `tb_tipeuser` (`id_tipeuser`, `tipeuser`, `id_user`, `tglupdate`) VALUES
(1, 'administrator', 1, '2020-10-19 06:04:53');
...
(1, 1, '2020-10-19 19:30:35', 0, 'Logout'),
(2, 1, '2020-10-19 21:00:10', 0, 'Login'),
(3, 1, '2020-10-19 21:02:07', 0, 'Logout'),
(4, 1, '2020-10-19 21:02:15', 0, 'Login'),
(5, 1, '2020-10-19 21:16:57', 0, 'Logout'),
(6, 1, '2020-10-19 21:17:05', 0, 'Login');
...
--
-- Indexes for table `tb_ceklist`
--
ALTER TABLE `tb_ceklist`
...
--
-- Indexes for table `tb_detailceklist`
--
ALTER TABLE `tb_detailceklist`
  ADD PRIMARY KEY (`id_detailceklist`);
...
--
-- Indexes for table `tb_mechanictype`
--
ALTER TABLE `tb_mechanictype`
  ADD PRIMARY KEY (`id_mechanictype`);
...
--
-- AUTO_INCREMENT for table `tb_ceklist`
--
ALTER TABLE `tb_ceklist`
  MODIFY `id_ceklist` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tb_detailceklist`
--
ALTER TABLE `tb_detailceklist`
  MODIFY `id_detailceklist` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_jenispekerjaan`
--
ALTER TABLE `tb_jenispekerjaan`
  MODIFY `id_jenispekerjaan` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tb_mechanictype`
--
ALTER TABLE `tb_mechanictype`
  MODIFY `id_mechanictype` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tb_tipeuser`
  MODIFY `id_tipeuser` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tb_userlog`
--
ALTER TABLE `tb_userlog`
  MODIFY `id_userlog` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
