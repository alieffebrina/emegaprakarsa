...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2020 at 03:08 PM
...
--
-- Table structure for table `tb_masterceklist`
--

CREATE TABLE `tb_masterceklist` (
  `id_masterceklist` int(11) DEFAULT NULL,
...
(1, 1, 'Master Customer', '', 'aktif'),
(2, 1, 'Tipe User', '', 'aktif'),
(3, 1, 'Master Departement', '', 'aktif'),
(4, 1, 'Master Staf', '', 'aktif'),
(5, 1, 'Master Checklist', '', 'aktif'),
